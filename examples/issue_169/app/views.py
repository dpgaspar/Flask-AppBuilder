...
class ContactModelView(ModelView):
    ...
    @action("muldelete", "Delete",
            Markup("<p>Delete all Really?</p><p>Ok then...</p>"), "fa-rocket")
...
class PostTweet(BaseView):
    ...
    def tweet(self):
        ...
        if resp.status == 403:
            ...
            flash(
                'Successfully tweeted your tweet (ID: #%s)' % resp.data['id'])
...
appbuilder.add_link(
    ...
    label="Add Contact")
appbuilder.add_view(
    TestForm, "My form View", icon="fa-group", label='My Test form')
