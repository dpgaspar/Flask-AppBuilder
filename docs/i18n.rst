...
You can add your own translations for your application, using Flask-BabelPkg, this is a fork from Flask-Babel, created because it wast not possible to separate package translations from the applications translations.
