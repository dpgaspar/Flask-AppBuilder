...
On you projects root create a babel directory, then create and edit a file named babel.cfg with the following content::

	[python: **.py]
	[jinja2: **/templates/**.html]
	encoding = utf-8
	
Then extract your strings to be translated, execute on you projects root::
