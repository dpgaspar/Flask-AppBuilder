...
F.A.B. has three language support, English, Portuguese and Spanish (planning for some more). This means that all messages, views and menus generated from the framework can be translated to these languages.

You can add your own translations for your application, using Flask-BabelPkg, this is a fork from Flask-Babel, created because it wast not possible to separate a package translations from the applications translations.
