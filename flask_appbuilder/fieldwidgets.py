...
class DatePickerWidget:
    ...
    data_template = (
        '<div class="input-group date appbuilder_date" data-provide="datepicker" id="datepicker">'
...
class DateTimePickerWidget:
    ...
    data_template = (
        '<div class="input-group date appbuilder_datetime" data-provide="datepicker" id="datetimepicker">'
        '<span class="input-group-addon"><i class="fa fa-calendar cursor-hand"></i>'
        "</span>"
