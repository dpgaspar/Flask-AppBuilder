...
class SecurityManager(BaseSecurityManager):
    ...
    def find_register_user(self, registration_hash):
        return self.get_session.query(self.registeruser_model).filter(
            self.registeruser_model.registration_hash ==
            registration_hash).scalar()
    ...
    def find_user(self, username=None, email=None):
        ...
        if username:
            return self.get_session.query(self.user_model).filter(
                func.lower(self.user_model.username) == func.lower(
                    username)).first()
        elif email:
            return self.get_session.query(
                self.user_model).filter_by(email=email).first()
    ...
    def count_users(self):
        return self.get_session.query(func.count('*')).select_from(
            self.user_model).scalar()
    ...
    def find_role(self, name):
        return self.get_session.query(
            self.role_model).filter_by(name=name).first()
    ...
    def get_public_permissions(self):
        role = self.get_session.query(
            self.role_model).filter_by(name=self.auth_role_public).first()
    ...
    def find_permission(self, name):
        ...
        """
        return self.get_session.query(
            self.permission_model).filter_by(name=name).first()
    ...
    def find_view_menu(self, name):
        ...
        """
        return self.get_session.query(
            self.viewmenu_model).filter_by(name=name).first()
    ...
    def find_permission_view_menu(self, permission_name, view_menu_name):
        ...
        return self.get_session.query(self.permissionview_model).filter_by(
