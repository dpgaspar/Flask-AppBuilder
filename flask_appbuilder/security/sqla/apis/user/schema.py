...
class UserPostSchema(Schema):
    ...
    password = fields.String(required=True, validate=[PasswordComplexityValidator()], description = password_description)
    roles = fields.List(fields.Integer, required=True, validate = [Length(1)], description = roles_description)
    username = fields.String(required=True, validate=[Length(1, 250)] ,  description = username_description)
...
class UserPutSchema(Schema):
    ...
    password = fields.String(required=False, validate=[PasswordComplexityValidator()], description = password_description)
    roles = fields.List(fields.Integer, required=False, validate=[Length(1)], description = roles_description)
    username = fields.String(required=False, validate=[Length(1, 250)],  description = username_description)
