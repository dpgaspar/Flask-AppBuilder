...
LOGMSG_ERR_SEC_DEL_RESET_PW_HASH = "Error deleting the expired password reset hash from db. {0} "
""" Error deleting the expired password reset hash, format with err message """
